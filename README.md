# XMC&trade; MCU: UART Printf

This code example demonstrates how to use the printf function with a Universal Serial Interface Channel (USIC) based UART in XMC&trade; MCU devices.
...
The following example will clone the "[UART Printf](https://github.com/Infineon/mtb-example-xmc-uart-printf)" application with the desired name "UARTPrintf" configured for the *KIT_XMC47_RELAX_V1* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_XMC47_RELAX_V1 --app-id mtb-example-xmc-uart-printf --user-app-name UARTPrintf --target-dir "C:/mtb_projects"
   ```
...
4. After programming, the application starts automatically. Confirm that the string "Hello World!" is displayed on the UART terminal.

   **Figure 1. "Hello World!" in terminal**

   ![](images/terminal-printf-application.png)
...
The implementation is realized by using UART resource. UART is configured by “**uart 1.0**”-personality in **Device Configurator** where such uart features were selected like baudrate, data bits, frame length.

​	**Figure 2. pin configuration**

![](images/uart_printf_pin_config.png)

 In the main function, **retarget_io_init()** is used to redirect **printf**-function to the external terminal like putty or tera term.
...
![](images/uart_printf_personality_usic.png)

<br>

**Figure 3. USIC (UART) settings**

![](images/uart_printf_conf_1.png)

<br>

**Figure 4. USIC (UART) settings**

![](images/uart_printf_config_2.png)
...
For XMC&trade; MCU devices, see [32-bit XMC&trade; industrial microcontroller based on Arm&reg; Cortex®-M](https://www.infineon.com/cms/en/product/microcontroller/32-bit-industrial-microcontroller-based-on-arm-cortex-m/).

## Document history

Document title: *CE231956* - *XMC MCU: UART Printf*
